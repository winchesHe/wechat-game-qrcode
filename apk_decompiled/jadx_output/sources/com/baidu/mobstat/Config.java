...
public class Config {
    ...
    public static final boolean SDK_HOOK_FILTER = false;
    ...
    public static final String STAT_SDK_VERSION_NUM = "4.0.7.6";
    ...
    public static final String LOG_SEND_URL = LOG_SEND_URL_SSL;
