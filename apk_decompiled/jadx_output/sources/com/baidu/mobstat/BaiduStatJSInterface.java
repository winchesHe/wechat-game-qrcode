...
public class BaiduStatJSInterface {
    ...
    public interface IWebviewPageLoadCallback {
        void onPageFinished(WebView webView, String str, ck ckVar);

        void onPageStarted(WebView webView, String str, ck ckVar);
    }
    ...
    public static class CustomWebViewClient extends WebViewClient {
        ...
        public CustomWebViewClient(Context context, WebViewClient webViewClient, IWebviewPageLoadCallback iWebviewPageLoadCallback, ck ckVar) {
        ...
        private void a(String str) throws JSONException, ClassNotFoundException {
            ...
            if ("onEventDuration".equals(string)) {
                ...
                long j = jSONObject2.getLong(TypedValues.TransitionType.S_DURATION);
    ...
    public static class CustomWebChromeViewClient extends WebChromeClient {
        ...
        public CustomWebChromeViewClient(Context context, WebChromeClient webChromeClient, ArrayList<IWebviewPageLoadCallback> arrayList, ck ckVar) {
            this.a = new WeakReference<>(context);
